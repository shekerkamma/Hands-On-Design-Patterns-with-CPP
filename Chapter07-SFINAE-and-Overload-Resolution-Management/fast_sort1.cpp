...
static_assert(sizeof(have_sort) != sizeof(have_range), "Do something else for yes/no types");
static_assert(sizeof(have_range) != sizeof(have_nothing), "Do something else for yes/no types");

// We have to use decltype twice as the other test_sort function with begin and end also has two parameters.
template <typename T>
