...
public:
    ...
    template <typename N, typename D>
    Ratio(const N &num, const D &denom) : value_(static_cast<double>(num) / static_cast<double>(denom)) {}
...
public:
    Ratio() : value_() {}
    Ratio(const double &num, const D &denom) : value_(num / static_cast<double>(denom)) {}
    explicit operator double() const { return value_; }
...
public:
    Ratio() : value_() {}
    Ratio(const N &num, const double &denom) : value_(static_cast<double>(num) / denom) {}
    explicit operator double() const { return value_; }
