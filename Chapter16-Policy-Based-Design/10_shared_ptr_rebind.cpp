...
struct DeleteByFree
{
    ...
    template <typename U>
    using rebind_type = DeleteByFree<U>;
};
...
struct DeleteDestructorOnly
{
    ...
    template <typename U>
    using rebind_type = DeleteDestructorOnly<U>;
};
...
struct DeleteSmallHeap
{
    ...
    template <typename U>
    using rebind_type = DeleteSmallHeap<U>;
...
public:
    ...
    template <typename U>
    using rebind_type = SmartPtr<U, typename DeletionPolicy::template rebind_type<U>, CopyMovePolicy, ConversionPolicy>;
