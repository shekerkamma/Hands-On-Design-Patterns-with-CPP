...
public:
    ...
    typename std::enable_if<ArrowPolicy::have_arrow, U*>::type operator->() { return p_; }
    template <typename U = T>
    typename std::enable_if<ArrowPolicy::have_arrow, const U*>::type operator->() const { return p_; }
